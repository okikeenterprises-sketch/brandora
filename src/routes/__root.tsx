...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "BrandoraX — Africa's outcome-driven digital workforce pipeline. Train. Get placed. Build the future." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { title: "BrandoraX Academy" },
      { property: "og:title", content: "BrandoraX Academy" },
      { name: "twitter:title", content: "BrandoraX Academy" },
      { property: "og:description", content: "BrandoraX — Africa's outcome-driven digital workforce pipeline. Train. Get placed. Build the future." },
